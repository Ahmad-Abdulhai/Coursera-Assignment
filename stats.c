 ...
 * software. Alex Fosdick alnd the University of Colorado are not liable for any
 * misuse of this material. 
 *
 *****************************************************************************/
/**
 * @file <satas.c> 
 * @brief <This program analyzes the data entered by the user >
 *
 * <Add Extended Description Here>
 *
 * @author Ahmad Abdulhai
 * @date 17.9.2024
 *
 */
